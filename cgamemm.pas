...
const
  ...
  DataGaussPrimaryRapidFire: array [0..1] of array of LongWord =
  (
...
begin
  ...
  if Assigned(ProcMem) and (dwModuleBase^ > 0) then begin
      ...
      if State then begin
        ...
        { ------- Gauss primary ON ------ }
        for i:=0 to High(DataGaussPrimaryRapidFire[1])-1 do begin
          ProcMem.WriteByte(DataGaussPrimaryRapidFire[1,1 + i] , dwModuleBase^ + DataGaussPrimaryRapidFire[1,0] + i);
        end;
        ...
        { ------- Gauss primary OFF ----- }
        for i:=0 to High(DataGaussPrimaryRapidFire[0])-1 do begin
          ProcMem.WriteByte(DataGaussPrimaryRapidFire[0,1 + i] , dwModuleBase^ + DataGaussPrimaryRapidFire[0,0] + i);
        end;
